...
check_cpuid:
	...
	; copy to ecx as we;; for comparing later 
	mov ecx, eax
	...
	; Copy FLAGS bac kto eax (with the flipped bit if CPUID is supported)
	pushfd
	pop eax
	...
	; Compare eax and ecx if they are equal then CPUID isn't supported
	cmp eax, ecx
	je .no_cpuid
	ret
.no_cpuid:
...
check_long_mode:
	...
	jb .no_long_mode	; if the cpu is too olf for long mode
